...
function register($username, $email, $password) 
{
  ...
  if ($result->num_rows > 0) 
  {
    throw new Exception('Пользователь с таким e-mail уже существует - вернитесь '
                         .'на форму регистрации и выберите другое имя.');
  }
...
function check_valid_user() 
{
  ...
  {
    echo 'Вы вошли в систему под именем  <b>'
      .stripslashes($_SESSION['valid_user']).'</b>.';
    echo "<br />";
  } 
  else 
  {
...
function notify_password($username, $password) 
{
  ...
  else 
  {
    ...
    $email = $row->email;
    $from = "From: support@phpPersonalTimer \r\n";
    $mesg = "Ваш пароль для входа в систему Personal Timer изменен на $password \r\n"
            ."Пожалуйста, учтите это при будущем входе в систему. \r\n";
          
    if (mail($email, 'Информация о входе в систему Personal Timer', $mesg, $from))
      return true;      
    else
